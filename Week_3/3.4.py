...
words = [clean_word(word) for line in open('source.txt', 'r') for word in line.split() if clean_word(word)]
frequencytabel = generate_tabel(words)

dict_file = 'source.frequency.txt'
dict_to_file(frequencytabel, dict_file)

trie = Trie(words)
trie_file = 'source.trie.txt'
